...
This repository is created and contains a script to build a "Project Factory"; a shell script that automates the creation of the workspace, configures settings via the command line, and handles system signals.
---
